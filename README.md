# ✨ Keshav Kumar Jha's Web Development Portfolio ✨
...
<div align="center">
  <img src="https://raw.githubusercontent.com/TheRealSaiTama/SimpleHTML/main/assets/portfolio-banner.png" alt="Portfolio Banner" width="800px" />
  <p><i>Building the web, one project at a time</i></p>
</div>
...
*   **Inspiration**: [Simple Tabs Project](https://roadmap.sh/projects/simple-tabs) on roadmap.sh
*   **How to Use**: Navigate to the `Tabs` directory and open `index.html`.
*   **Learn More**: [Tabs README](Tabs/README.md)
...
*   **Inspiration**: [Tooltip UI Project](https://roadmap.sh/projects/tooltip-ui) on roadmap.sh
...
│
├─ Q1 2023: Basic HTML & CSS Projects (Projects 1-3)
│
├─ Q2 2023: JavaScript Fundamentals (Projects 4-7)
│
├─ Q3 2023: UI Components & Accessibility (Projects 8-10)
│
├─ Q4 2023: Interactive Applications (Projects 11-15)
│
